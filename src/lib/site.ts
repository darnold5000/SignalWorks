export const siteConfig = {
  ...
  description:
    "Professional websites without agency pricing. Modern websites, custom software, and AI solutions backed by real software engineering. Built for Midwest businesses.",

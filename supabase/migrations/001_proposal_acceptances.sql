-- Signal Works proposal acceptances (shared Dugout Intel Supabase project).
-- Creates ONLY sw_proposal_acceptances. Inserts via service role from SignalWorks API.
